    ...
    while True:
        if CURRENT_HOUR > 0 and (CURRENT_HOUR-LAST_HOUR) == 1:
            ...
            if (gallons_needed_to_irrigate_no_adj-gallons_needed_to_irrigate_adj)>0:
                lcd.setCursor(0,1)
                lcd.message("H2O saved: %.2f gal"%(gallons_needed_to_irrigate_no_adj-gallons_needed_to_irrigate_adj))
                print("Amount of H2O saved: %.2f gal"%(gallons_needed_to_irrigate_no_adj-gallons_needed_to_irrigate_adj))
            else:
                lcd.setCursor(0,1)
                lcd.message("H2O lost: %.2f gal"%(gallons_needed_to_irrigate_adj-gallons_needed_to_irrigate_no_adj))
